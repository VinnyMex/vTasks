...
const ALL_LINKS = [
  ...
  { icon: Coffee, label: "Passeios Planejados", desc: "Roteiro turístico e passeios", href: "/passeios", category: "✈️ ImigraPro (Espanha)" },
  { icon: CalendarDays, label: "Calendário Imigração", desc: "Eventos e lembretes", href: "/calendario-imigracao", category: "✈️ ImigraPro (Espanha)" },
